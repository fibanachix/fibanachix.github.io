const texts = {
    ...
    //why_us
    whyUs1: "/ чому ми /",
    whyUs2: "Чому люди вибирають саме Нас?",
    whyUs3: 'Юридична фірма "OTS" - це досвідчені адвокати, індивідуальне обслуговування та успішні результати. <br><br>Вибирайте нас за наш досвід, самовідданість і відданість вашій справі.  <br><br>Довіртеся нам, і ми досягнемо позитивних результатів!',
    ...
    contact8: "Надіслати",
    contact9: "провідна юридична фірма з командою досвідчених адвокатів, готових допомогти вам з усіма вашими юридичними потребами.",
    contact10: "Навігація",
    contact11: "Головна",
    contact12: "Про нас",
    contact13: "Послуги",
    ...
    whyUs3: '"OTS" law firm offers experienced lawyers, individual service and successful results. <br> <br>Choose us for our experience, dedication and dedication to your cause.  <br><br>Trust us and we will achieve positive results!',
    ...
    contact3: "Mail:",
    contact4: "Messengers:",
    contact5: "Address:&nbsp;&nbsp;&nbsp;&nbsp; Kiev, Zhilyanskaya STR. 126/23 of. 203-204",
    contact6: "Write to us",
    contact7: "Your question...", //placeholder
    contact8: "Send",
    contact9: "a leading law firm with a team of experienced lawyers ready to help you with all your legal needs.",
    ...
    home2: "Практикующие,",
    home3: "высококвалифицированные адвокаты обеспечат высококачественную юридическую помощь",
    ...
    whyUs3: 'Юридическая фирма "OTS" - это опытные адвокаты, индивидуальное обслуживание и успешные результаты. <br><br>Выбирайте нас за наш опыт, самоотверженность и преданность вашему делу. <br><br>Доверьтесь нам, и мы достигнем положительных результатов!',
    ...
    contact5: "Адрес:&nbsp;&nbsp;&nbsp;&nbsp; г. Киев, ул. Жилянская 126/23 оф. 203-204",
    contact6: "Написать нам",
    contact7: "Ваш вопрос...", //placeholder
    contact8: "Выслать",
    contact9: "ведущая юридическая фирма с командой опытных адвокатов, готовых помочь вам со всеми вашими юридическими потребностями.",
    contact10: "Навигация",
    contact11: "Главная",
    contact12: "Про нас",
    contact13: "Услуги",
